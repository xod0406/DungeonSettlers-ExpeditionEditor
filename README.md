# Dungeon Settlers Expedition Editor v2.1.1

대상 게임: **Dungeon Settlers DS_B.0.4.17**  
...
이 릴리스는 **Dungeon Settlers DS_B.0.4.17** 기준으로 제작·검증되었습니다. 게임 업데이트로 `GameAssembly.dll` 코드 위치나 IL2CPP 구조가 바뀌면 일부 기능이 작동하지 않을 수 있습니다.


## 0.4.17 compatibility
This build updates the native `DetermineEstablishTalents` patch sites for DS_B.0.4.17. The gameplay/UI/persistence logic is otherwise unchanged from the verified v2.1 Stable build.
